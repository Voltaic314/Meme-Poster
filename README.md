...
Anyways that's how it works. It is scheduled in crontab on aRaspberry Pi so reddit grabber runs every 15 minutes and FB poster runs every other (even) hours at :00 minutes I believe. 
