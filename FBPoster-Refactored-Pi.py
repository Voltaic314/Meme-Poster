...
def formatted_parameters(title, id, permalink, url, size, hash):
    """
...
if __name__ == '__main__':
    ...
    for posts in values_fb:
        ...
        chosen_id = str(chosen_post[1])
        chosen_permalink = str(chosen_post[2])
        chosen_url = str(chosen_post[3])
        chosen_size = str(chosen_post[4])
        chosen_hash = str(chosen_post[5])
